...
# HyChecker
HyChecker is a Python script that allows you to check multiple avaiable usernames with one click for the game [Hytale](https://hytale.com) by [Hypixel Studios](https://x.com/hypixel).
